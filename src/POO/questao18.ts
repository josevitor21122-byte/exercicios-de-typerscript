...
class Colaborador {
    ...
    constructor(nome: string, matricula: string, salarioBase: number, tipo: string) {
        this._nome = nome
...
class Professor extends Colaborador {
    ...
    constructor(nome: string, matricula: string, salarioBase: number, regimeTrabalho: string) {
...
class Diretor extends Colaborador {
    ...
    private gratificacaoFuncao: number

    constructor(nome: string, matricula: string, salarioBase: number, departamento: string, gratificacaoFuncao: number) {
